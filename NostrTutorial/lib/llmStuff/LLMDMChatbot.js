...
export async function check_NIP65_published(
  ...
  if (events.length == 0) {
    ...
    console
    console.log(`We found your npub= ${nip19.npubEncode(getPublicKey(nip19.decode(nsec).data))} already published on some of the relays you listed`)
  }
}

export async function llm_dm_chatbot_response(relays, nsec, nip_65_relays, npub,  BASE_URL, OPENAI_API_KEY) {
  console.log("MY_NPUB")
  console.log(npub)
